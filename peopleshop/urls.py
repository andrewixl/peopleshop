...
from apps.auth.views import account_profile
from .views import member_index, member_action

urlpatterns = [
    # Landing page area
    # url(r'^$', TemplateView.as_view(template_name='main/index.html'), name='landing_index'),
    ...
    url(r'^user/', include('apps.selling.urls')),
